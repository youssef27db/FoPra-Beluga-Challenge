...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha, fc1dims=256, fc2dims=256, chkpt_dir='tmp/ppo'):
...
class CriticNetwork(nn.Module):
    def __init__(self, input_dims, alpha, fc1dims=256, fc2dims=256, chkpt_dir='tmp/ppo'):
